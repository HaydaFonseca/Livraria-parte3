    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.IntegerField(choices=[(1, "Pendente"), (2, "Concluída"), (3, "Cancelada")], default=1),
                ),
                (
                    "usuario",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="compras", to=settings.AUTH_USER_MODEL
                    ),
                ),
                ("livros", models.ManyToManyField(related_name="compras", to="core.livro")),
            ],
        ),
    ]
